...
ENVIRONMENT["fireclickdetector"] = newcclosure(function(Target)
	...
	local NewPart = Instance.new("Part", game:GetService("Workspace))
	do
	...
	local HeartbeatConnection = RunService["Heartbeat"]:Connect(function()
		local CurrentCamera = game:GetService("workspace")["CurrentCamera"] or game:GetService("workspace")["Camera"]
...
ENVIRONMENT["getloadedmodules"] = newcclosure(function()
    ...
    for _, v in pairs(game:GetDescendants()) do
        if typeof(v) == "Instance" and v:IsA("ModuleScript") then table.insert(LoadedModules, v) end
    end
